...
final class PShutdownHookThread extends Thread {
	...
	public PShutdownHookThread(List<AutoCloseable> activeTargets, List<Thread> activeThreads, List<OutputProvider> activeProviders) {
